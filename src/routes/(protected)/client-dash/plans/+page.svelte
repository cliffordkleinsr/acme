...
{#if client_pack.payment_status}
	<div id="printable" class="m-4 mx-auto w-full max-w-3xl">
		<Card.Root class="w-full">
			<Card.Header class="flex w-full flex-col items-start bg-muted/50 p-4 sm:flex-row sm:p-6">
				...
				<div class="flex items-center gap-1 sm:ml-auto" id="non-printable">
					<Button size="sm" variant="outline" class="h-8 gap-1">
						...
						<span class="whitespace-nowrap"> Modify Package </span>
					</Button>
					<DropdownMenu.Root>
						<DropdownMenu.Trigger asChild let:builder>
							<Button builders={[builder]} size="icon" variant="ghost" class="relative h-8 w-8">
						...
						<DropdownMenu.Content align="end">
							<div class="" id="non-printable">
								<Button variant="ghost" class="w-full gap-3" on:click={() => window.print()}>
			...
			>
				...
				<Pagination.Root count={10} class="mr-0 w-auto sm:ml-auto">
					<Pagination.Content>
						<Pagination.Item>
