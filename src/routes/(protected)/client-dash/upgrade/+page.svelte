<script lang="ts">
    ...
    export let data
    let stripe: Stripe | null | any = null
    onMount(async() =>{
...
<Popover.Root>
  ...
  <Popover.Content>
    <form method="post" class=" space-y-3" >
        ...
        <Input type="text" name="price" value={$clientPackage.price} class="hidden"/>
...
<span class="absolute top-20 right-14 flex h-3 w-3">
