...
<div class="grid lg:grid-cols-2 gap-1 m-4 lg:w-4/6">
    <div class="grid gap-2">
        <h1 class="text-2xl font-bold">Account</h1>
        <p class=" font-semibold text-muted-foreground">Manage your account settings and preferences.</p>
        <p class="text-md font-semibold mt-2">Preview</p>
    ...
    <div class="grid gap-2 h-1/2">
        <div class=""></div>
        <form method="POST" class="grid gap-2 max-w-md h-1/2" use:enhance>
