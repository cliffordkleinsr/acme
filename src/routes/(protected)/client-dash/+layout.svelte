		...
		<header class="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
			...
			<DropdownMenu.Root>
				...
				<DropdownMenu.Content align="end">
					...
					<DropdownMenu.Item class="gap-3.5" href="/client-dash/settings"
						><Settings class="size-4" />Settings</DropdownMenu.Item
					>
					<DropdownMenu.Item class="gap-3.5" href="/client-dash/subscriptions/myplan">
						<CandlestickChart class="size-4" /> Pricing Plans</DropdownMenu.Item
					>
					<DropdownMenu.Item class="gap-3.5" href="/client-dash/plans"
						><CreditCard class="size-4" />Billing & Payments</DropdownMenu.Item
					>
					<DropdownMenu.Item class="gap-3.5" href="/client-dash/settings/support"
						><Tag class="size-4" />Support</DropdownMenu.Item
					>
					<DropdownMenu.Separator />
