    ...
    <div class="grid gap-4">       
        <div class="grid gap-3">
            ...
            <Card.Header class="space-y-4">
                ...
                <Card.Description>
                  <Button class="float-end" href="/superuser/dash/management" variant="outline"><Undo2 class="size-4"/> Back</Button>
                </Card.Description>
                <Separator />
            </Card.Header>
                    ...
                    <Dialog.Content>
                      <form action="?/draftSurvey" method="post" class="space-y-2">
                        <Dialog.Header>
                          ...
                          <Dialog.Description>
                            This action cannot be undone. This will permanently delete all analytics received from this survey.
                          </Dialog.Description>
                        </Dialog.Header>
      ...
      <Card.Root class="lg:w-full auto-rows-auto">
        ...
        <Card.Content class="space-y-3">
          <div class="flex gap-2">
            ...
            {/if}
            {#if surv_data.status === 'Draft'}
              <p class="text-red-500 -py-4 font-semibold">SELECT TO DELETE MULTIPLE</p>
            {/if}
          </div>
