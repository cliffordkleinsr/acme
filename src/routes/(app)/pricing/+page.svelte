...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
      ...
      <!-- Card -->
    <Card.Root class="dark:shadow-lg hover:dark:shadow-orange-500/50 transition duration-1000">
        <Card.Header>
            <Card.Title class="font-bold text-center pb-5">Free</Card.Title>
            <Card.Title class="text-5xl font-bold text-center pb-2">Free</Card.Title>
            <Card.Description class="text-center">Forever free</Card.Description>
        </Card.Header>
        <Card.Content>
      ...
      <!-- End Card -->
      <!-- Card -->
      <Card.Root class="border-primary dark:shadow-lg hover:dark:shadow-orange-500/50 transition duration-1000">
        <Card.Header class="space-y-2.5">
          <Button class="w-32 h-6 mx-auto" disabled>MOST POPULAR</Button>
          <Card.Title class="font-bold text-center">Startup</Card.Title>
          {#if checked}
          <Card.Title class="text-5xl font-bold text-center pb-2">$ 39</Card.Title>
          {:else}
          <Card.Title class="text-5xl font-bold text-center pb-2">$ 69</Card.Title>
          {/if}
          <Card.Description class="text-center">All the basics for starting a new <br>business</Card.Description>
        </Card.Header>
        <Card.Content>
            <ul class="mt-9 space-y-2.5 text-sm">
                <li class="flex space-x-2">
                  <svg class="flex-shrink-0 mt-0.5 size-4 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                  <span class="text-gray-800 dark:text-neutral-400">
                    2 Surveys 
      ...
      <Card.Root class="dark:shadow-lg hover:dark:shadow-orange-500/50 transition duration-1000">
          <Card.Header>
              <Card.Title class="font-bold text-center pb-5">Team</Card.Title>
              {#if checked}
              <Card.Title class="text-5xl font-bold text-center pb-2">$ 89</Card.Title>
              {:else}
              <Card.Title class="text-5xl font-bold text-center pb-2">$ 149</Card.Title>
              {/if}
              <Card.Description class="text-center">Everything you need for a growing business</Card.Description>
          </Card.Header>
          <Card.Content>
      ...
      <Card.Root class="dark:shadow-lg hover:dark:shadow-orange-500/50 transition duration-1000">
        <Card.Header>
            <Card.Title class="font-bold text-center pb-5">Enterprise</Card.Title>
            <Card.Title class="text-5xl font-bold text-center pb-2">Custom</Card.Title>
            <Card.Description class="text-center">Advanced features for scaling your business</Card.Description>
        </Card.Header>
        <Card.Content>
        ...
        <Table.Root class="table-auto">
            <Table.Header>
                <Table.Row class="text-lg font-semibold dark:bg-neutral-900">
                    ...
                    <Table.Head class="dark:text-white px-6 text-black">Free</Table.Head>
                    <Table.Head class="dark:text-white text-black">Startup</Table.Head>
                    <Table.Head class="dark:text-white text-black">Team</Table.Head>
