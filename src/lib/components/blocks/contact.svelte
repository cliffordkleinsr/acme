...
<div class="mx-auto max-w-2xl lg:max-w-5xl">
	<div class="text-center">
		<h1 class="text-3xl font-bold text-gray-800 dark:text-white sm:text-4xl">Contact us</h1>
	...
	<div class="mt-12 grid items-center gap-6 lg:grid-cols-2 lg:gap-16">
		<!-- Card -->
		<div class="flex flex-col rounded-xl border p-4 dark:border-neutral-700 sm:p-6 lg:p-8">
		...
		<div class="divide-y divide-gray-200 dark:divide-neutral-800">
			...
			<div class=" flex gap-x-7 py-6">
				<svg
					...
					/><path d="m22 10-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 10" /></svg
				>
				<div class="grow">
