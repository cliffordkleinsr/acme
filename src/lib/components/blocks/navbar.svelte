...
>
	...
	>
		...
		<DropdownMenu.Root>
			...
			<DropdownMenu.Content class="mt-4 text-muted-foreground transition-colors">
				<DropdownMenu.Group>
					...
					<DropdownMenu.Item href="/industries/financial_services"
						>Financial services</DropdownMenu.Item
					>
					<DropdownMenu.Item href="/industries/ngo">NGO's</DropdownMenu.Item>
				</DropdownMenu.Group>
		...
		<DropdownMenu.Root>
			...
			<DropdownMenu.Content class="mt-4 text-muted-foreground transition-colors">
				<DropdownMenu.Group>
					<DropdownMenu.Item href="/services/corp_rep">Corporate reputation</DropdownMenu.Item>
					<DropdownMenu.Item href="/services/brand_image">Brand image</DropdownMenu.Item>
					<DropdownMenu.Item href="/services/customer_experience"
						>Customer experience</DropdownMenu.Item
					>
					<DropdownMenu.Item href="/services/product_assessment"
						>Product assessment</DropdownMenu.Item
					>
					<DropdownMenu.Item href="/services/market_reaserch">Market research</DropdownMenu.Item>
				</DropdownMenu.Group>
			</DropdownMenu.Content>
		</DropdownMenu.Root>
