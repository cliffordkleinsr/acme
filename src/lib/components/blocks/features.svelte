...
<div class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
	...
	<div class="lg:grid lg:grid-cols-12 lg:items-center lg:justify-between lg:gap-16">
		<div class="lg:col-span-5 lg:col-start-1">
			<!-- Title -->
			<div class="mb-8">
				<h2 class="mb-2 text-3xl font-bold text-gray-800 dark:text-neutral-200 lg:text-4xl">
		...
		<div class="mt-10 lg:col-span-6 lg:col-end-13 lg:mt-0">
			<div class="space-y-6 sm:space-y-8">
				<!-- List -->
				<ul
					class="grid grid-cols-2 divide-x-2 divide-y-2 divide-gray-200 overflow-hidden dark:divide-neutral-700"
				>
					<li class="-m-0.5 flex flex-col p-4 sm:p-8">
						<div
							class="mb-2 flex items-end gap-x-2 text-3xl font-bold text-gray-800 dark:text-neutral-200 sm:text-5xl"
						>
							45k+
						</div>
						<p class="text-sm text-gray-600 dark:text-neutral-400 sm:text-base">
