	...
	<Dialog.Root bind:open={multidialog}>
		...
		<Dialog.Content class="sm:max-w-[425px]">
			...
			>
				...
				{/if}
				<Button variant="secondary" on:click={multiples.add} disabled={$multiplesDisabled}
					>Add Option</Button
				>
				<Button variant="secondary" on:click={multiples.remove} disabled={$multiplesOther}
	...
	<Dialog.Root bind:open={optidialog}>
		...
		<Dialog.Content class="sm:max-w-[425px]">
			...
			>
				...
				{/if}
				<Button variant="secondary" on:click={options.add} disabled={$optionsDisabled}
					>Add Option</Button
				>
				<Button variant="secondary" on:click={options.remove} disabled={$optionsOther}
					>Remove Option</Button
				>
...
{#if isDesktop}
	<Dialog.Root bind:open={stardialog}>
		<Dialog.Trigger asChild let:builder>
			<Button variant="outline" builders={[builder]} class="flex gap-2 text-center text-xs"
...
{:else}
	<Drawer.Root bind:open={stardialog}>
		<Drawer.Trigger asChild let:builder>
			<Button variant="outline" builders={[builder]} class="flex gap-2">
...
{#if isDesktop}
	<Dialog.Root bind:open={likertdialog}>
		<Dialog.Trigger asChild let:builder>
			<Button variant="outline" builders={[builder]} class="flex gap-2 text-xs">
...
{#if isDesktop}
	<Dialog.Root bind:open={rankdialog}>
		<Dialog.Trigger asChild let:builder>
			<Button variant="outline" builders={[builder]} class="flex gap-2 text-xs">
				<BarChart4 class="size-4" /> Add a ranking question</Button
			>
		</Dialog.Trigger>
		<Dialog.Content class="sm:max-w-[425px]">
			<Dialog.Header class="space-y-3">
			...
			>
				...
				{/if}
				<Button variant="secondary" on:click={rankers.add} disabled={$rankersDisabled}
					>Add Option</Button
				>
				<Button variant="secondary" on:click={rankers.remove} disabled={$optionsOther}
					>Remove Option</Button
				>
		...
		<Drawer.Content>
			...
			>
				...
				<Button variant="secondary" on:click={rankers.add} disabled={$rankersDisabled}
					>Add Option</Button
				>
				<Button variant="secondary" on:click={rankers.remove} disabled={$rankersOther}
					>Remove Option</Button
				>
				<Button type="submit" class="max-w-sm" disabled={rank_loading}>
					{#if rank_loading}
