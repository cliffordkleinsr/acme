...
{#if type === "soft-grey"} 
    <!-- Toast -->
    <div class=" absolute top-20 right-9 max-w-xs bg-gray-100 border border-gray-200 text-sm text-gray-800 rounded-lg dark:bg-white/10 dark:border-white/20 dark:text-white" role="alert">
      <div class="flex p-4">
        {message}
      </div>
    </div>
 ...
 {:else if type ==="dark-grey"} 
    <!-- Toast -->
    <div class=" absolute top-20 right-9 max-w-xs bg-gray-50 border border-gray-200 text-sm text-gray-600 rounded-lg dark:bg-white/10 dark:border-white/10 dark:text-neutral-400" role="alert">
      <div class="flex p-4">
        {message}
      </div>
    </div>
...
{:else if type ==='info'}
    <!-- Toast -->
    <div class="absolute top-20 right-9 max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700" role="alert">
      <div class="flex p-4">
